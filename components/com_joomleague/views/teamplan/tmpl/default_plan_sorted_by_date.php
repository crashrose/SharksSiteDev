...
?>
			...
			<table class='fixtures'>
				<tr class="sectiontableheader">
					<th class="td_l" colspan=16>
						<?php echo JoomleagueHelper::getMatchDate($match, JText::_('COM_JOOMLEAGUE_CLUBPLAN_MATCHDATE'));?>
					</th>
				</tr>
	...
	<tr class="<?php echo $highlight; ?>"<?php echo $favStyle; ?>>
		...
		{
			?>
		<td width="10%"><?php echo JoomleagueHelperHtml::showMatchTime(	$match, $this->config, $this->overallconfig, $this->project); ?></td>
		<?php
		}
		?>
