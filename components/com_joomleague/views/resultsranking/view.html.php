...
require_once( JLG_PATH_SITE .DIRECTORY_SEPARATOR. 'models' .DIRECTORY_SEPARATOR. 'ranking.php' );
require_once( JLG_PATH_SITE .DIRECTORY_SEPARATOR. 'models' .DIRECTORY_SEPARATOR. 'results.php' );
require_once( JLG_PATH_SITE .DIRECTORY_SEPARATOR. 'views' .DIRECTORY_SEPARATOR. 'results' .DIRECTORY_SEPARATOR. 'view.html.php' );
