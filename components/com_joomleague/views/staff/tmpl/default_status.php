	...
	<table class="status">
		...
		if ($this->inprojectinfo->injury > 0)
		{
			...
			if (is_array($this->roundsdata))
			{
				...
				{
					$injury_date = JHtml::date($this->roundsdata[$this->inprojectinfo->injury_date]['date_first'], 'COM_JOOMLEAGUE_GLOBAL_MATCHDAYDATE', $this->overallconfig['time_zone']);
				...
				{
					$injury_end = JHtml::date($this->roundsdata[$this->inprojectinfo->injury_end]['date_last'], 'COM_JOOMLEAGUE_GLOBAL_MATCHDAYDATE', $this->overallconfig['time_zone']);
		...
		if ($this->inprojectinfo->suspension > 0)
		{
			...
			if (is_array($this->roundsdata))
			{
				...
				{
					$suspension_end = JHtml::date($this->roundsdata[$this->inprojectinfo->suspension_end]['date_last'], 'COM_JOOMLEAGUE_GLOBAL_MATCHDAYDATE', $this->overallconfig['time_zone']);
		...
		if ($this->inprojectinfo->away > 0)
		{
			...
			if (is_array($this->roundsdata))
			{
				...
				{
					$away_date = JHtml::date($this->roundsdata[$this->inprojectinfo->away_date]['date_first'], 'COM_JOOMLEAGUE_GLOBAL_MATCHDAYDATE', $this->overallconfig['time_zone']);
				...
				{
					$away_end = JHtml::date($this->roundsdata[$this->inprojectinfo->away_end]['date_last'], 'COM_JOOMLEAGUE_GLOBAL_MATCHDAYDATE', $this->overallconfig['time_zone']);
