...
class JFormFieldFlagsFolder extends JFormField
{
	...
	{
		$folderlist = array();
		$folderlist1 = JFolder::folders(JPATH_ROOT.DIRECTORY_SEPARATOR.'images', '', true, true, array(0 => 'system'));
	    $folderlist2 = JFolder::folders(JPATH_ROOT.DIRECTORY_SEPARATOR.'media' , '', true, true, array(0 => 'system'));
