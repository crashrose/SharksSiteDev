...
class JoomleagueModelTeamPlan extends JoomleagueModelProject
{
	...
	function _getResultsPlan($team=0,$ordering='ASC',$referee=0,$getplayground=0,$getreferee=0)
	{
		...
		$query_SELECT=' SELECT m.*,DATE_FORMAT(m.time_present,"%H:%i") time_present,t1.id AS team1,t2.id AS team2,r.roundcode,r.id roundid,r.project_id,r.name, p.timezone ';
