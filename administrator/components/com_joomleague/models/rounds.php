...
require_once (JLG_PATH_ADMIN.DIRECTORY_SEPARATOR.'models'.DIRECTORY_SEPARATOR.'list.php');
	...
	*/
	...
	function populateByTemplate($project_id, $filename, $time, $interval, $start, $roundname, $teamsorder = null, $iMatchnumber=0)
	{
		...
		if (! $handle) {
			...
			$this->setRedirect ( 'index.php?option=com_joomleague&view=rounds', $msg, 'error' );
			return;
		}
		$delimiter = ";";
		$row = 1;
