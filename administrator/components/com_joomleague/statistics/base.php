...
require_once ( JLG_PATH_ADMIN .DIRECTORY_SEPARATOR. 'helpers' .DIRECTORY_SEPARATOR. 'jlparameter.php' );
/**
...
class JLGStatistic extends JObject {
	...
	function &getInstance($class)
	{
		...
		{
			$file = JLG_PATH_SITE.DIRECTORY_SEPARATOR.'extensions'.DIRECTORY_SEPARATOR.$type.DIRECTORY_SEPARATOR.'admin'.DIRECTORY_SEPARATOR.'statistics'.DIRECTORY_SEPARATOR.$class.'.php';
			if (file_exists($file))
			{
				require_once($file);
				$stat = new $classname();
		...
		{
			$file = JLG_PATH_ADMIN .DIRECTORY_SEPARATOR. 'statistics' .DIRECTORY_SEPARATOR.$class.'.php';
			if (!file_exists($file)) {
	...
	function getBaseParams()
	{
		...
		$paramsdefs = JLG_PATH_ADMIN.DIRECTORY_SEPARATOR.'statistics' .DIRECTORY_SEPARATOR. 'base.xml';
