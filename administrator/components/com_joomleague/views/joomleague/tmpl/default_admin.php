...
<table style="width: 100%">
	<tr>
		...
		<div id="element-box">
			<div class="m">
			<div id="navbar">
			<a href='#' style='text-decoration: none; color: green; padding: 2px;'><?php echo $this->version; ?></a>
			...
			<?php
				...
				foreach ($extensions as $e => $extension) {
					...
					$menufile = $JLGPATH_EXTENSION .DIRECTORY_SEPARATOR. 'admin' .DIRECTORY_SEPARATOR.'views'.DIRECTORY_SEPARATOR.'joomleague'.DIRECTORY_SEPARATOR.'tmpl'.DIRECTORY_SEPARATOR.'default_'.$extension.'.php';
