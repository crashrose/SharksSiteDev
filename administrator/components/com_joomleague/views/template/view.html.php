...
class JoomleagueViewTemplate extends JLGView
{
	function display($tpl=null)
	{
		...
		foreach ($extensions as $e => $extension) {
			...
			{
				if (file_exists($extensiontpath.DIRECTORY_SEPARATOR.'settings'.DIRECTORY_SEPARATOR.'default'.DIRECTORY_SEPARATOR.$template->template.'.xml'))
				{
					$xmlfile=$extensiontpath.DIRECTORY_SEPARATOR.'settings'.DIRECTORY_SEPARATOR.'default'.DIRECTORY_SEPARATOR.$template->template.'.xml';
				}
			}
		}
