...
$this->addTemplatePath(JPATH_COMPONENT.DIRECTORY_SEPARATOR.'views'.DIRECTORY_SEPARATOR.'joomleague');
				...
				<tbody>
					...
					for ($i=0, $n=count($this->projectteam); $i < $n; $i++)
					{
						...
						<tr class="<?php echo "row$k"; ?>">
							...
							<td class="center">
								<?php
								if (empty($row->picture) || !JFile::exists(JPATH_SITE.DIRECTORY_SEPARATOR.$row->picture))
								{
