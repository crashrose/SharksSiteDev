...
function updateVersion($versionData)
{
	...
	$status=0;
	$updateVersionFile=JPATH_ADMINISTRATOR.DIRECTORY_SEPARATOR.'components'.DIRECTORY_SEPARATOR.'com_joomleague'.DIRECTORY_SEPARATOR.'assets'.DIRECTORY_SEPARATOR.'updates'.DIRECTORY_SEPARATOR.'update_version.sql';
