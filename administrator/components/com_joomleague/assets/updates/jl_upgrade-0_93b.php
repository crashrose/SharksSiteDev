...
'WINS' => 'JL_WINS'
	...
	{
		//echo '<br />';
		$xmldir=JPATH_SITE.DIRECTORY_SEPARATOR.'components'.DIRECTORY_SEPARATOR.'com_joomleague'.DIRECTORY_SEPARATOR.'settings'.DIRECTORY_SEPARATOR.'default';
...
function updateVersion($version,$updatefilename)
{
	...
	$updateVersionFile=JPATH_COMPONENT_ADMINISTRATOR.DIRECTORY_SEPARATOR.'assets'.DIRECTORY_SEPARATOR.'updates'.DIRECTORY_SEPARATOR.'update_version.sql';
